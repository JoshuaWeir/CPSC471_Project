...
$user = $uc->getAdmin($_SESSION["userId"]);
            ...
            <div class="card ">
                ...
                <div class="bg-white shadow-sm pt-4 pl-2 pr-2 pb-2">
                    ...
                    <ul role="tablist" class="nav bg-light nav-pills rounded nav-fill mb-3">
                        <li class="nav-item"> <a type="submit" class="nav-link active btn btn-success" href="addPage.php?"> <i class="fas fa-credit-card mr-2"></i> Add Books </a> </li>
                        <li class="nav-item"> <a type="submit" class="nav-link active btn btn-warning" href="deletePage.php?"> <i class="fas fa-credit-card mr-2"></i> Delete Books </a> </li>
